...
public class InternetInterfacer {
	...
	ParserConfigurationException, SAXException {
		...
		System.out.println("ETA: " + doc.getElementsByTagName("text").item(0).getTextContent());
		System.out.println("Do: " + doc.getElementsByTagName("maneuver").item(0).getTextContent());
		System.out.println("Distance: " + doc.getElementsByTagName("text").item(1).getTextContent());
